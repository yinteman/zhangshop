...
$proid=$_REQUEST['id'];
echo $proid;
$prosInfo=getproOne($proid);
//var_dump($prosInfo);
if (!($prosInfo&& is_array($prosInfo))) {
	alerMsg("请重新选择商品","index.php");
}
$proImags=getAllImgByProId($proid);
//var_dump($proImags);
...
<meta charset="utf-8">
<title>商品介绍</title>
<link type="text/css" rel="stylesheet" href="prestyles/reset.css">
<link type="text/css" rel="stylesheet" href="prestyles/main.css">
<link type="text/css" rel="stylesheet" media="all" href="prestyles/jquery.jqzoom.css"/>

<script src="plugins/jquery-1.6.js" type="text/javascript"></script>
<script src="plugins/jquery.jqzoom-core.js" type="text/javascript"></script>
...
<div class="userPosition comWidth">
	...
	<span>&nbsp;&gt;&nbsp;</span>
	<a href="#"><?php echo $prosInfo['cname'];?></a>
	<span>&nbsp;&gt;&nbsp;</span>
	<em><?php echo $prosInfo['pname'];?></em>
</div>
	...
	<div class="description clearfix">
		<div class="leftArea">
			<div class="description_imgs">
				<div class="big">
				   <a href="image800/<?php $proImags[0]['albumpath'];?>" class="jqzoom" rel='gal1'  title="triumph"></a>
					<img src="image350/<?php $proImags[0]['albumpath'];?>" alt="" title="triumph">
				</div>
				<ul class="des_smimg clearfix">
				    <?php foreach ($proImags as $key => $proImag):
				          if ($proImags && is_array($proImag)):

				      ?>
					<li><a class="<?php echo $key==0?"zoomThumbActive":"";?> active" href='javascript:void(0);' rel="{gallery: 'gal1', smallimage: 'image350/<?php echo $proImag['albumpath'];?>',largeimage: 'image800/<?php echo $proImag['albumpath'];?>'}"><img src="image50/<?php echo $proImag['albumpath'];?>" alt=""></a></li>
					<?php
                        endif;
                        endforeach;
		...
		<div class="rightArea">
			<div class="des_content">
				<h3 class="des_content_tit"><?php echo  $prosInfo['pname'];?></h3>
				<div class="dl clearfix">
					<div class="dt">我的价格</div>
					<div class="dd clearfix"><span class="des_money"><em>￥</em><?php $prosInfo['iprice'];?></span></div>
				</div>
				<div class="dl clearfix">
					<div class="dt">优惠</div>
